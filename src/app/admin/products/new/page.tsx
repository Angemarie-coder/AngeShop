...
export default function AddProduct() {
  ...
  const subcategories = {
    ...
    'Home & Kitchen': ['Appliances', 'Furniture', 'Decor', 'Kitchenware', 'Lighting'],
    ...
    'Toys': ['Educational', 'Action Figures', 'Board Games', 'Puzzles', 'Arts & Crafts'],
    'Automotive': ['Car Care', 'Accessories', 'Tools', 'Electronics', 'Safety']
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            {/* Dimensions */}
            <div className="mt-6">
              <label className="block text-sm font-medium text-gray-700 mb-4">Dimensions (cm)</label>
